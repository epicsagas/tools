...
```sh
cd ~/Downloads
wget https://github.com/epicsagas/tools/releases/download/tdl-v0.2.1/tdl-x86_64-linux-gnu.AppImage
chmod +x tdl-x86_64-linux-gnu.AppImage
./tdl-x86_64-linux-gnu.AppImage
```
